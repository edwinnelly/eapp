            ...
            <div class="col-lg-7 col-md-7 modal-bg-img" style="">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h3 class="mt-3 text-center">Activate account to continue</h3>
                        ...
                        <form name="myForm" id="myForm" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" id="reset-btn" class="btn btn-block btn-dark">Activate</button>
                                </div>
                                <div class="col-lg-12 text-center mt-5">
                                    Already have an account? <a href="resendotp" class="text-danger">Resend Otp</a>
                                </div>
                            </div>
                        </form>
                    </div>
