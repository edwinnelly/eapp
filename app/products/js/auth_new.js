  ...
  if (!email.match(emailPattern)) {
    ...
    return false;
      ...
      if (username.length<8) {
        ...
        $(".alert").alert('close'); 
        var notification = '<div class="alert alert-danger alert-dismissible bg-danger text-white border-0 fade show" role="alert">';
        notification += 'Username must be at least 8 characters long.';
        notification += '<button type="button" class="close" data-dismiss="alert" aria-label="Close">';
        notification += '<span aria-hidden="true">&times;</span></button></div>';
        $("#notificationContainer").append(notification);
        return false;
      ...
      if (username === "") {
        ...
        $(".alert").alert('close'); 
        var notification = '<div class="alert alert-danger alert-dismissible bg-danger text-white border-0 fade show" role="alert">';
        notification += 'Username must not be empty.';
        notification += '<button type="button" class="close" data-dismiss="alert" aria-label="Close">';
        notification += '<span aria-hidden="true">&times;</span></button></div>';
        $("#notificationContainer").append(notification);
        return false;
    ...
    $("#notificationContainer").append(notification);
      ...
      if (!regex.test(username)) {
        ...
        $(".alert").alert('close'); 
        var notification = '<div class="alert alert-danger alert-dismissible bg-danger text-white border-0 fade show" role="alert">';
        notification += 'Username can only contain letters, numbers, and underscores.';
        notification += '<button type="button" class="close" data-dismiss="alert" aria-label="Close">';
        notification += '<span aria-hidden="true">&times;</span></button></div>';
