...
<head>
    ...
    <title>Control Panel Lentose App</title>
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1" id="greet">Good Morning Jason!</h3>
                                    ...
                                    <div class="ml-auto">
                                        <div class="dropdown sub-dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd1">
                                                ...
                                                <a class="dropdown-item" href="index.html#">Update</a>
...
if (new Date().getHours() < 18) {
  document.getElementById("greet").innerHTML =  "Good day <?php echo $username1;  ?>";
}else{
    document.getElementById("greet").innerHTML =  "Good day <?php echo $username1;  ?>";
}
</script>
